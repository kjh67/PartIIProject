...
def splat_from_video(src, tgt):

    tgt = run_preprocessing(src, tgt)
...
if __name__ == "__main__":
    ...
    if args.reconstruction_type.lower() == "nerf":
        nerf_from_video(args.source_path, args.target_path)
    elif args.reconstruction_type.lower() == "splat":
        splat_from_video(args.source_path, args.target_path)
    else:
